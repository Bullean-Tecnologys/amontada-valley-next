...
import comunidade from "@/assets/comunidade.webp";
      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto max-w-6xl px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className=" mb-6 text-gradient-primary text-3xl md:text-5xl">
                Amontada Valley
              </h2>
              ...
              <div className="text-justify text-lg text-foreground/80 space-y-6">
                <p>
                  ...
                  <a
                    ...
                    className="text-primary transition-smooth cursor-pointer font-semibold"
                  >
                    Pague Menos
                  </a>{" "}
                  e do{" "}
                  <a
                    ...
                    className="text-primary transition-smooth font-semibold"
                  >
                    NINNA Hub
                  </a>{" "}
          ...
          <div className="mx-auto w-full max-w-6xl px-6">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Princípios que impulsionam nosso progresso
              </p>
            </div>
        ...
        <section className="container mx-auto max-w-6xl px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="relative w-full overflow-hidden rounded-2xl shadow-lg h-[320px] md:h-[380px]">
                <img
                  src={comunidade}
                  alt="Comunidade"
                  className="w-full h-full object-cover"
              ...
              <div>
                  <h2 className="text-3xl md:text-5xl font-bold mb-4">
                    Nosso <span className="text-[#FF4000]">propósito</span>
                  </h2>

                  <div className="text-justify text-lg text-foreground/80 space-y-6">
                      <div>
                        <h3 className="text-xl font-semibold text-[#FF4000]">
                          Visão
                        </h3>
                        <p>
                          Construir uma comunidade capaz de aprender, cria e inovar, gerando impacto sustentável e ampliando o futuro
                          das pessoas de Amontada e região
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          Oferecer formação acessível e de qualidade em tecnologia, criatividade e empreendedorismo, 
                          reduzindo desigualdades e capacitando pessoas para transformar realidades
                        </p>
                      </div>                   
                  </div>
              </div>
